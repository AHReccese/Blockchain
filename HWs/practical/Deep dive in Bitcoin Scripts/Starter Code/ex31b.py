...
def Q31_scriptSig(txin, txout, txin_scriptPubKey):
    ...
    return [
        Ata_sig, OP_0, sh1_sig, sh2_sig, sh4_sig # just an example :)
    ]


def send_from_Q31_transaction(amount_to_send, txid_to_spend, utxo_index,txin_scriptPubKey, txout_scriptPubKey, network_type):
    txout = create_txout(amount_to_send, txout_scriptPubKey)
    txin = create_txin(txid_to_spend, utxo_index)
    txin_scriptSig = Q31_scriptSig(txin, txout, txin_scriptPubKey)
...
if __name__ == '__main__':
    ...
    txid_to_spend = (
        'd47eb80dba09fc8daa85cace2db9206a26e8e01c6b4d56938e1d988408c7ec8d')
    ...
    response = send_from_Q31_transaction(
